...
**Контур качества воздуха (Fan)** смотрит на датчики CO2, PM2.5, VOC, NOx, влажность — и решает, с какой скоростью крутить вентилятор: `low`, `medium` или `high`. Чем хуже показатели относительно порогов, тем выше скорость; можно задать отдельные пороги под свой набор датчиков.

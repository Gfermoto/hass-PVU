...
![Установка Turkov Zenit Heco](images/photos/photo_1.jpg)
...
![Монтаж установки](images/photos/photo_2.jpg)
...
Blueprint завязан на стандартную climate-сущность Home Assistant и на входы (input_*): сущность, датчики, пороги задаются в мастере, а не захардкожены. Перед каждой отправкой команды проверяется, что режим входит в `hvac_modes` / `fan_modes` атрибутов climate-сущности; невалидные или unknown-состояния датчиков обрабатываются без падения. Я проверял только на Turkov, но на любой другой установке с climate в HA можно попробовать тот же blueprint, подставив свои entity_id и при необходимости подстроив пороги под свою логику.
...
![Итоговая конфигурация](images/photos/photo_3.jpg)

...
- [ ] Добавить валидацию выбросов датчиков (нереалистичные значения).
- [ ] Уточнить README по edge-cases и "что делать при unknown/unavailable".
- [ ] Сформировать FAQ из повторяющихся вопросов в issues/TG.
